...
function white_label_admin_color_scheme()
{
    ...
    <?php
    $menu_background = esc_html(white_label_get_option('admin_color_scheme_menu_background', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#23282d' : '#1e1e1e')));
    $menu_text = esc_html(white_label_get_option('admin_color_scheme_menu_text', 'white_label_visual_tweaks', '#ffffff'));
    $menu_highlight = esc_html(white_label_get_option('admin_color_scheme_menu_highlight', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#0073aa' : '#3858e9')));
    $submenu_background = esc_html(white_label_get_option('admin_color_scheme_submenu_background', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#2c3338' : '#0c0c0c')));
    $submenu_text = esc_html(white_label_get_option('admin_color_scheme_submenu_text', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#e5e5e5' : '#bbbbbb')));
    $submenu_highlight = esc_html(white_label_get_option('admin_color_scheme_submenu_highlight', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#0073aa' : '#7c90ff')));
    $notifications = esc_html(white_label_get_option('admin_color_scheme_notifications', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#d54e21' : '#3858e9')));
    $links = esc_html(white_label_get_option('admin_color_scheme_links', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#0073aa' : '#3858e9')));
    $links_focus = hex_tint($links, -10);
    $buttons = esc_html(white_label_get_option('admin_color_scheme_buttons', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#2371b1' : '#3858e9')));
    $buttons_darken = hex_tint($buttons, -10);
    $form_fields = esc_html(white_label_get_option('admin_color_scheme_form_fields', 'white_label_visual_tweaks', (version_compare($wp_version, '7.0', '<') ? '#2371b1' : '#3858e9'))); ?>
    <style type="text/css">
    ...
    /* Admin Menu: current */ #adminmenu .wp-submenu li.current a, #adminmenu a.wp-has-current-submenu:focus + .wp-submenu li.current a, #adminmenu .wp-has-current-submenu.opensub .wp-submenu li.current a { color: <?php echo $menu_text; ?>; } #adminmenu .wp-submenu li.current a:hover, #adminmenu .wp-submenu li.current a:focus, #adminmenu a.wp-has-current-submenu:focus + .wp-submenu li.current a:hover, #adminmenu a.wp-has-current-submenu:focus + .wp-submenu li.current a:focus, #adminmenu .wp-has-current-submenu.opensub .wp-submenu li.current a:hover, #adminmenu .wp-has-current-submenu.opensub .wp-submenu li.current a:focus { color: <?php echo $submenu_highlight; ?>; } #adminmenu li.current a.menu-top, #adminmenu li.wp-has-current-submenu a.wp-has-current-submenu, #adminmenu li.wp-has-current-submenu .wp-submenu .wp-submenu-head, .folded #adminmenu li.current.menu-top { color: <?php echo $menu_text; ?>; background: <?php echo $menu_highlight; ?>; } #adminmenu li.wp-has-current-submenu div.wp-menu-image:before, #adminmenu a.current:hover div.wp-menu-image:before, #adminmenu li.wp-has-current-submenu a:focus div.wp-menu-image:before, #adminmenu li.wp-has-current-submenu.opensub div.wp-menu-image:before, #adminmenu li:hover div.wp-menu-image:before, #adminmenu li a:focus div.wp-menu-image:before, #adminmenu li.opensub div.wp-menu-image:before, .ie8 #adminmenu li.opensub div.wp-menu-image:before { color: <?php echo $menu_text; ?>; }
...
/**
 * Manipulate the WordPress logo in the admin bar.
 *
 * @param mixed $wp_admin_bar admin bar menus.
 *
 * @return void
 */
function white_label_admin_bar_logo($wp_admin_bar)
{
    $admin_remove_wp_logo = white_label_get_option('admin_remove_wp_logo', 'white_label_visual_tweaks', false);
    $admin_replace_wp_logo = white_label_get_option('admin_replace_wp_logo', 'white_label_visual_tweaks', false);
    $admin_remove_wp_logo_link = white_label_get_option('admin_remove_wp_logo_link', 'white_label_visual_tweaks', false);
    $admin_replace_wp_logo_link = white_label_get_option('admin_replace_wp_logo_link', 'white_label_visual_tweaks', false);

    // Remove WordPress Logo
    if ($admin_remove_wp_logo === 'on' || $admin_replace_wp_logo) {
        if (!$admin_replace_wp_logo) {
...
add_action('admin_bar_menu', 'white_label_admin_bar_logo', 999);
 ...
 * @return void
 */
function white_label_change_howdy()
{
    global $wp_admin_bar;
...
add_filter('wp_before_admin_bar_render', 'white_label_change_howdy');

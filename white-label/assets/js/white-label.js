document.addEventListener('DOMContentLoaded', function (e) {
    ...
    const settings_tables = ['admin_welcome_panel_content', 'admin_remove_dashboard_widgets', 'admin_widget_content', 'admin_custom_dashboard_content', 'custom_notification_content', 'hidden_plugins', 'elementor_editor_navigation', 'gravity_forms_toolbar_links', 'searchwp_header_menu', 'gravity_forms_settings_panels', 'searchwp_algorithm_menu', 'searchwp_settings_menu', 'searchwp_tools_menu', 'hidden_themes', 'sidebar_menus', 'hidden_admin_bar_nodes_backend', 'hidden_admin_bar_nodes_frontend', 'admin_footer_credit'];
